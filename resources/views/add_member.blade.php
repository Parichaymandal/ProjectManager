...
<div class="col-sm-6">
                ...
                <div class="card bg-warning">
                    <div  class="card-body">
                        ...
                        <div class="col-sm-7">
                            ...
                            <h6>{{$member->email}}</h6>
                            <!--see prfl buttn-->
                            <a href="{{route('employee.show',$member->id)}}" style="margin-top: 100px" class="btn btn-primary">See Profile</a>
                        </div>
                    </div>
                </div>
    ...
    @endforeach
	 <!--add member buttn-->
	<a href="search-member" type="button" class="btn btn-success"style="width:300px;margin-left:250px ;margin-top:20px">ADD NEW</a>
	</div>
   <div class="col-sm-2">
	<h4></h4>  
   </div>
